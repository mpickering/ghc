...
liftTc  = mk_known_key_name OccName.tcName   liftLib
libCls = mk_known_key_name OccName.clsName  thLib
thFun  = mk_known_key_name OccName.varName  thSyn
liftFun  = mk_known_key_name OccName.varName  liftLib
thTc   = mk_known_key_name OccName.tcName   thSyn
thCls  = mk_known_key_name OccName.clsName  thSyn
liftCls  = mk_known_key_name OccName.clsName  liftLib
...
codeCTyConName         = thTc (fsLit "CodeC")          codeCTyConKey
